        ...
        <div className="md:w-full w-[85%]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-2xl transition duration-300">
            ...
            <div className="mt-10 bg-teal-100 dark:bg-gray-700 rounded-2xl p-6 shadow-md md:mb-20">
            ...
            <div className="mt-10 md:text-left text-center grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 md:mb-4">
                  ...
                  captivates the fusion of art and photography. Held at renowned
                  venues, Consequat is a premier photography and art exhibition
                  that provides international exposure to both established and
                  emerging photographers and artists, opening doors to new
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4 md:text-left text-center">
              ...
              Alongside photography, it was our second year exhibiting artworks,
              and our event witnessed remarkable growth, with 150+ participants
              from across the world, including the USA, Bangladesh, Germany,
              Israel, and Australia. A total of over 450+ frames were displayed,
              a significant increase from the previous year.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-4 md:text-left text-center">
              Over the past three years, we have had the privilege of
              collaborating with renowned photographers such as Shibasish Saha,
              Jayanta Guha, Shayan Bose, Rajdip Paul, Satyaki Acharya, Anirban
              Pan, Shaayer Mukherjee, Subrata Bysack, Santanu Roychowdhury,
              Siddhartha Paul, and more, who judged the exhibited photographs in
              categories like Wildlife, Street, Portrait, and Landscape. Notable
              personalities like Debabrata Bhattacharya and Ujjal Biswas have
              also served as judges for artworks.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-4 md:text-left text-center">
              In recognition of their talent, winners in each category received
              attractive prizes, while every participant was awarded a medal and
              a certificate. This year, we’re taking Consequat to even greater
              heights. In 2025, we will be organizing Consequat at the Nandalal
              Bose and Jamini Roy Galleries at ICCR on May 3rd and 4th, 2025.
            </p>
          </div>
